    ...
    methods: {
        async submitForm() {
            ...
            try {
                ...
                this.errorMessage = 'Error al crear la recomendación. Inténtalo de nuevo.';
            } finally {
                this.loading = false;
            }
        },
...
<template>
    <div class="container mx-auto px-4 ">
        <h1 class="text-2xl font-bold mb-4 text-center text-violet-950">Sube una nueva recomendación</h1>
        ...
        <form @submit.prevent="submitForm">
            ...
            <div>
                <button type="submit" class="mr-2 py-2 px-4 bg-blue-500 text-white rounded" :disabled="loading">Crear</button>
